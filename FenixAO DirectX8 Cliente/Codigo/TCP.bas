    ...
    Select Case Left$(sdata, 3)
            ...
            Else
               If bLluvia(UserMap) <> 0 Then
                    If bTecho Then
                        ...
                        Call Audio.StopWave
                        Call Audio.PlayWave("lluviainend.wav", 0, 0, Enabled)
                        frmMain.IsPlaying = plNone
                   ...
                   Else
                        ...
                        Call Audio.StopWave
                        Call Audio.PlayWave("lluviaoutend.wav", 0, 0, Enabled)
                        frmMain.IsPlaying = plNone
        ...
        Case "QDL"
            ...
            Exit Sub
                   ...
                   Case "SMT"                  ' >>>>> Set the Weather :: SMT
            Rdata = Right$(Rdata, Len(Rdata) - 3)
            Niebla = IIf(Val(Rdata) = 1, True, False)
            If Rdata = 1 Then
            Niebla = True
            ElseIf Rdata = 0 Then
            Niebla = False
...
Call InitGrh(CharList(CharIndex).Aura, Val(ReadField(15, Rdata, 44)))
        ...
        Case "TM"
                ...
                If Val(ReadField(1, Rdata, 45)) <> 0 Then
                    ...
                    Call ReproducirMusica(Val(ReadField(1, Rdata, 45)))
                    'LoopMidi = Val(ReadField(2, Rdata, 45))
                    Call Audio.PlayMIDI(App.Path & "\Midi\" & CurMidi)
                End If
            Exit Sub
        Case "LH"
            LastHechizo = Timer
